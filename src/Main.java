...
public class Main {
	...
	public static void main(String[] args) throws NumberFormatException, RemoteException {
		Customer customer1 = new Customer(1, "Emre", "Piriþtine", LocalDate.of(2000, 9, 11), Long.parseLong("11111111111"));
		Game game1 = new Game(1, "Assasins Creed: Valhalla", 19);
		Campaign campaign1=new Campaign(1, "Okul", 10);
